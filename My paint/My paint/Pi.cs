...
namespace My_paint
{
    class Pi
    {
        //public static void DrawCircle(InfiNum rad, out string[] points)
        //{
        ...
        //    InfiNum ONEsegment = new InfiNum(InfiNum.Root(InfiNum.Add(InfiNum.Pow(InfiNum.Subtract(pt_2[0], pt_1[0]), "2"), InfiNum.Pow(InfiNum.Subtract(pt_2[1], pt_1[1]), "2")), "2"));

        //    InfiNum circumference = new InfiNum(InfiNum.Multiply(ONEsegment.Value, InfiNum.Multiply(InfiNum.Pow("2", "200"), "8")));

        //    InfiNum PI = new InfiNum(InfiNum.Divide(circumference.Value, InfiNum.Multiply(rad.Value, "2")));
